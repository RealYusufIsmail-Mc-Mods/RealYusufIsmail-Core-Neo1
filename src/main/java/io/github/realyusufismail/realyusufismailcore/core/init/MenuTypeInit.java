...
public class MenuTypeInit {
    public static DeferredRegister<MenuType<?>> MENU_TYPES =
            DeferredRegister.create(Registries.MENU, RealYusufIsmailCore.MOD_ID);

    public static final DeferredHolder<MenuType<?>, MenuType<LegacySmithingMenu>> LEGACY_SMITHING_TABLE =
