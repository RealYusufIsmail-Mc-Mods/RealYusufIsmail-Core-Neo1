...
public class DimensionProvider implements DataProvider {
    ...
    public DimensionProvider(DataGenerator generator, ExistingFileHelper existingFileHelper,
            String modid) {
    ...
    public @NotNull CompletableFuture<?> run(@NotNull CachedOutput cachedOutput) {
        ...
        val dimension = new DimensionBuilder(modid, existingFileHelper);
    ...
    private void saveData(CachedOutput cache, DimensionBuilder jsonObject) {
